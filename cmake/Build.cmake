...
FUNCTION(GROUP_SOURCES)
    ...
    LIST(FILTER SHADER_FILES INCLUDE REGEX ".+\.(vert|tesc|tese|geom|frag|comp|hlsl)$")
    ...
    FOREACH (SHADER_FILE ${SHADER_FILES})
        ...
        FILE(RELATIVE_PATH SHADER_FILE_PATH_REL ${ARG_PATH} "${SHADER_FILE_PATH}")
        IF (MSVC)
            STRING(REPLACE "/" "\\" SHADER_FILE_PATH_REL_MSVC "${SHADER_FILE_PATH_REL}")
            SET(SHADER_FILE_PATH_REL "Shader Files\\${SHADER_FILE_PATH_REL_MSVC}")
        ENDIF ()
        SOURCE_GROUP("${SHADER_FILE_PATH_REL}" FILES "${SHADER_FILE}")
    ENDFOREACH ()
ENDFUNCTION()
